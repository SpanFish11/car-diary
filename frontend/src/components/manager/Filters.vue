<template>
  <div>
    <div>
      ...
      <b-button id="popover-reactive-1" size="sm" ref="button">Filters</b-button>
    </div>
      ...
      <div>
        ...
        >
          <b-input-group size="sm">
            <b-form-input :disabled="input1.length > 0" v-model="input2" type="number" placeholder="From year"
                          aria-label="First name"></b-form-input>
            <b-form-input :disabled="input1.length > 0" v-model="input3" type="number" placeholder="Until year"
                          aria-label="Last name"></b-form-input>
          </b-input-group>
        </b-form-group>
        ...
        <b-form-group
            ...
            class="sm"
        >
          <b-form-input placeholder="Pick a model" list="my-list-id" v-model="model"></b-form-input>

          <datalist id="my-list-id">
            <option v-for="option in options" v-bind:key="option.id">{{ option.text }}</option>
          </datalist>
        </b-form-group>

        <b-button @click="onClose" class="mr-2" size="sm" variant="danger">Cancel</b-button>
        <b-button @click="onReset" class="mr-2" size="sm" variant="warning">Reset</b-button>
