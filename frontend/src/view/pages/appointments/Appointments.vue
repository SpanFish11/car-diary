    ...
    <div v-if="appointments.length !== 0">
      <v-simple-table>
        <template v-slot:default>
          <thead>
            <tr>
              <td class="text-left">Type of works</td>
              <td class="text-left">Car Information</td>
            ...
            <tr v-for="item in appointments" :key="item.id">
              <td>
                <div v-if="item.repairment">
                  <v-btn color="deep-orange lighten-2" disabled>
                    Repairment
                  </v-btn>
                </div>
                <div v-else>
                  <v-dialog
                    v-model="dialogRegularService"
                    width="500px"
                    :retain-focus="false"
                  >
                    ...
                    <v-card>
                      <v-card-title>
                        Information about Regular Service</v-card-title
                      >
                      <v-divider class="mx-4"></v-divider>
                      <v-card-text flat>
                        <div
                          v-for="operation in regularService.operations"
                          :key="operation.name"
                        >
                        ...
                        <div
                          v-for="detail in regularService.details"
                          :key="detail.name"
                        >
