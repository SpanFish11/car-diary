...
INSERT INTO m_clients (firstname, lastname, email, password)
VALUES ('Frank', 'Stephens', 'fijosij228@laraskey.com',
        '$2a$10$I2qMFWjftjgIcoYAaday4uxfiJfe8q4b/ISefQDbPOX0D3T4pOjHW');
...
INSERT INTO m_cars (mileage, photo_url, vin_code, year, model_id, ours, client_id, equipment_id,
                    price, used)
VALUES (0, 'url', '4S3BMHB68B3386050', 2018, 1, true, 1, 1, 10000.00, false);
INSERT INTO m_cars (mileage, photo_url, vin_code, year, model_id, ours, client_id, equipment_id,
                    price, used)
VALUES (0, 'url', '4S3BMHB68B3486050', 2019, 2, true, 1, 1, 20000.00, false);
INSERT INTO m_cars (mileage, photo_url, vin_code, year, model_id, ours, client_id, equipment_id,
                    price, used)
VALUES (0, 'url', '4S3BMHB68B3586050', 2020, 1, true, 2, 1, 20000.00, false);
