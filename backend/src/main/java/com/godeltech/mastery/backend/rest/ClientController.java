...
public class ClientController {
  ...
  public ResponseEntity<List<AppointmentDTO>> getAllAppointments(final @AuthenticationPrincipal User principal) {
  ...
  public ResponseEntity<HttpStatus> changePassword(
      @RequestBody @Valid final ResetPasswordRequest request, final @AuthenticationPrincipal User principal) {
